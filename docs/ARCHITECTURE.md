...
| **UptimeRobot** | SaaS – monitoring | Checks `/api/health` and the frontend every 5 minutes; public status page | External uptime monitoring and alerting; free |

### Cloud computing concepts demonstrated

- **Service models:** PaaS (Render), DBaaS (MongoDB Atlas), SaaS (Brevo, UptimeRobot, GitHub).
...
- **Observability:** Render logs and metrics, plus UptimeRobot external monitoring and a status page.
...
flowchart LR
    ...
    API -- "HTTPS" --> BREVO
    UR -. "GET /api/health every 5 min" .-> API
    UR -. "GET /" .-> WEB
